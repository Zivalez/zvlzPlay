package com.idlix;
final class Idlix$load$5 extends kotlin.coroutines.jvm.internal.SuspendLambda implements kotlin.jvm.functions.Function2 {
    ...
    Idlix$load$5(String p2, String p3, Integer p4, com.idlix.DetailResponse p5, java.util.List p6, Object p7, java.util.List p8, String p9, java.util.List p10, kotlin.coroutines.Continuation p11)
    {
        this.$poster = p2;
        this.$backdrop = p3;
        this.$year = p4;
    ...
    {
        kotlin.coroutines.Continuation v11_0 = new com.idlix.Idlix$load$5;
    ...
    public final Object invoke(com.lagradost.cloudstream3.MovieLoadResponse p3, kotlin.coroutines.Continuation p4)
    {
        return ((com.idlix.Idlix$load$5) this.create(p3, p4)).invokeSuspend(kotlin.Unit.INSTANCE);
    }

    public bridge synthetic Object invoke(Object p2, Object p3)
    {
        return this.invoke(((com.lagradost.cloudstream3.MovieLoadResponse) p2), ((kotlin.coroutines.Continuation) p3));
    }
    ...
    public final Object invokeSuspend(Object p14)
    {
        ...
        switch (this.label) {
            case 0:
                ...
                kotlin.Unit v1_6 = ((com.lagradost.cloudstream3.MovieLoadResponse) this.L$0);
            ...
            case 1:
                v0_2 = ((com.lagradost.cloudstream3.MovieLoadResponse) this.L$0);
                kotlin.ResultKt.throwOnFailure(p14);
                break;
            default:
